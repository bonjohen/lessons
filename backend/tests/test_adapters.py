...
class TestChromaDBAdapter:
    ...
    def test_index_and_count(self, adapter):
        chunks = [
            {"chunk_id": "c1", "chunk_text": "hello world", "lesson_id": "l1", "repo_id": "r1",
             "title": "T1", "summary": "S1", "heading_path": "H1", "lesson_url": "/l/1", "tags": ["a"], "chunk_index": 0},
            {"chunk_id": "c2", "chunk_text": "goodbye world", "lesson_id": "l1", "repo_id": "r1",
             "title": "T1", "summary": "S1", "heading_path": "H2", "lesson_url": "/l/1", "tags": [], "chunk_index": 1},
        ]
    ...
    def test_query_returns_results(self, adapter):
        chunks = [
            {"chunk_id": "c1", "chunk_text": "python testing", "lesson_id": "l1", "repo_id": "r1",
             "title": "Testing", "summary": "", "heading_path": "Testing", "lesson_url": "/l/1", "tags": ["testing"], "chunk_index": 0},
        ]
    ...
    def test_delete_collection(self, adapter):
        chunks = [
            {"chunk_id": "c1", "chunk_text": "text", "lesson_id": "l1", "repo_id": "r1",
             "title": "T", "summary": "", "heading_path": "H", "lesson_url": "/l/1", "tags": [], "chunk_index": 0},
        ]
